...
module.exports = {
  ...
  OWNER_NUMBER: settings.OWNER_NUMBER || process.env.OWNER_NUMBER || "2347039663381",
  OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Brian🥶",
  DEV: process.env.DEV || "2347039663381",
